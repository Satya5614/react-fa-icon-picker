...
var IconPickerItem = function (_a) {
    ...
    return (React.createElement("div", { onClick: function () { return !!onClick && onClick(icon); }, style: __assign({ fontSize: size, color: color, padding: 2 }, containerStyles) },
        React.createElement("i", { className: "fa " + icon, style: { fontSize: size, color: color }, "aria-hidden": "true" })));
};
